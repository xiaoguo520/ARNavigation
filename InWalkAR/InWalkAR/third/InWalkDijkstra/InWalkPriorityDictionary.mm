...
typedef std::unordered_map<KeyType, ObjType, inWalkKeyHasher, inWalkKeyEqual> Dictionary;
...
@implementation InWalkPriorityDictionary
{
    Dictionary _dict;
    Order _order;
    bool _heapified;
...
+(InWalkPriorityDictionary*)dictionary
{
    return [[InWalkPriorityDictionary alloc] initAscending:YES];
}

+(InWalkPriorityDictionary*)dictionaryAscending:(BOOL)asc
{
    return [[InWalkPriorityDictionary alloc] initAscending:asc];
}
