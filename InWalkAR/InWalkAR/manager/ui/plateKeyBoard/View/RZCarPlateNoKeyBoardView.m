...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    frame = CGRectMake(0, 0, rz_kScreenWidth, self.rz_cellHeight * 4 + rz_kSafeBottomMargin + 10 + collapseHeight);
    if (self = [super initWithFrame:frame]) {
        ...
        btn.frame = CGRectMake(0, 0, rz_kScreenWidth, collapseHeight);
        //btn.backgroundColor = [UIColor redColor];
        //[btn setImage:[UIImage imageNamed:@"RZCarPlateNoResource.bundle/collapse"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"rzCollapse.png"
...
- (void)layoutSubviews {
    ...
    self.frame = CGRectMake(0, 0, rz_kScreenWidth, self.rz_cellHeight * 4 + rz_kSafeBottomMargin + 10 + collapseHeight);
    self.collectionView.frame =  CGRectMake(0, 0 + collapseHeight, rz_kScreenWidth, self.rz_cellHeight * 4 + 10);
